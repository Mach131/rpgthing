...
def getEquipTraitWeights(equipType : EquipmentSlot, rarity : int, hasCurse : bool) -> dict[EquipmentTrait, int]: #TODO: put on correct piece of equipment
    return {
        ...
        statDefTrait: 8 if equipType is EquipmentSlot.OVERALL else 0,
        statResTrait: 8 if equipType is EquipmentSlot.OVERALL else 0,
        statAccTrait: 8 if equipType is EquipmentSlot.HAT else 0,
        statAvoTrait: 8 if equipType is EquipmentSlot.SHOES else 0,
        statSpdTrait: 8 if equipType is EquipmentSlot.SHOES else 0,
